...
void swap(int* i, int* j);
    ...
    int main() {
        ...
        *p2 = temp;
        ...
        cout << "The first  element in a[] is " << p2[0] << " and the second element in a[] is " << p2[1]<<endl;
...
//x contains: 99
//x is 0 and y is 99
//The address of the first element is 0x7ffeefbff5d0
//The address of the second element is 0x7ffeefbff5d4
